 ...
 * @author in-sideFX
 */
public class UndecoratorSceneDemoWxflat extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        primaryStage = stage;
        primaryStage.setTitle("Undecorator Scene Demo WXFlat");
        ...
        // Overrides defaults
        undecoratorScene.addStylesheet("demoapp/wxflat/demoapp.css");
    ...
    private void handleShowNonResizableStage(ActionEvent event) throws Exception {
        UndecoratorSceneDemoWxflat undecoratorSceneDemo = new UndecoratorSceneDemoWxflat();
